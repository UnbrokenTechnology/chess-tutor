...
RUNGS: list[tuple[int, BotConfig]] = [
    # --- basement: d1q0 + p0 + rank (bare-curve shape shifted ~-130) ---
    (100,  BotConfig("t100",  depth=1, qsearch_depth=0, perception=0.0, avg_move_rank=6.4, endgame_skill=0)),
    (200,  BotConfig("t200",  depth=1, qsearch_depth=0, perception=0.0, avg_move_rank=5.6, endgame_skill=0)),
    (300,  BotConfig("t300",  depth=1, qsearch_depth=0, perception=0.0, avg_move_rank=4.8, endgame_skill=0)),
    (400,  BotConfig("t400",  depth=1, qsearch_depth=0, perception=0.0, avg_move_rank=3.9, endgame_skill=0)),
    (500,  BotConfig("t500",  depth=1, qsearch_depth=0, perception=0.0, avg_move_rank=3.3, endgame_skill=0)),
    (600,  BotConfig("t600",  depth=1, qsearch_depth=0, perception=0.0, avg_move_rank=2.6, endgame_skill=1)),
    (700,  BotConfig("t700",  depth=1, qsearch_depth=0, perception=0.0, avg_move_rank=2.0, endgame_skill=1)),  # measured 680
    (800,  BotConfig("t800",  depth=1, qsearch_depth=0, perception=0.0, endgame_skill=1)),                      # measured 796
    (900,  BotConfig("t900",  depth=1, qsearch_depth=1, perception=0.0, endgame_skill=1)),                      # measured 897
    (1000, BotConfig("t1000", depth=2, qsearch_depth=2, perception=0.0, endgame_skill=1)),                      # measured 1020
    # --- mid band: d1q1 / d2q2 x perception (0.1-res curves) ---
    (1100, BotConfig("t1100", depth=1, qsearch_depth=1, perception=0.1, endgame_skill=1)),                      # measured 1113
    (1200, BotConfig("t1200", depth=2, qsearch_depth=2, perception=0.1, endgame_skill=2)),                      # measured 1199
    (1300, BotConfig("t1300", depth=2, qsearch_depth=2, perception=0.15, endgame_skill=2)),
    (1400, BotConfig("t1400", depth=2, qsearch_depth=2, perception=0.2, endgame_skill=2)),                      # measured 1395
    (1500, BotConfig("t1500", depth=2, qsearch_depth=2, perception=0.3, endgame_skill=2)),                      # measured 1530
    (1600, BotConfig("t1600", depth=2, qsearch_depth=2, perception=0.35)),
    (1700, BotConfig("t1700", depth=2, qsearch_depth=2, perception=0.45)),
    (1800, BotConfig("t1800", depth=2, qsearch_depth=2, perception=0.6)),                                       # measured 1813
    # --- upper band: d4 x perception ---
    (1900, BotConfig("t1900", depth=4, perception=0.55)),
    (2000, BotConfig("t2000", depth=4)),                                                                        # measured 1967
    # --- ceiling: depth rungs; d5/d7 + d5/d6-perception are guesses ---
    (2100, BotConfig("t2100", depth=5, perception=0.6)),
    (2200, BotConfig("t2200", depth=5)),
    (2300, BotConfig("t2300", depth=6, perception=0.5)),
    (2400, BotConfig("t2400", depth=6)),                                                                        # measured 2411
    (2500, BotConfig("t2500", depth=7)),
]
